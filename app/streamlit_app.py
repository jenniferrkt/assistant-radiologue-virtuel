...
# ══════════════════════════════════════════════════════════════════════════════
    ...
    sample_images = [p for p in sample_images if p.parent.name == "sample_images"]

    if not sample_images:
        st.info("Aucune image synthétique trouvée dans le dossier data/sample_images/.")
    else:
        cols = st.columns(3)
